...
En cuanto a la asociación la calidad de sonido percibida con el estado de la ANC (encendido o apagado), la calidad resulta menor cuando el sistema está encendido.
...
% \begin{center}
%     \includegraphics[width=0.7\linewidth]{images/cross_Y2.png}
% \end{center}
% \vspace{\captionSpace}
% \begin{figure}[H]
%     \caption{Gráfico de barras para la calidad de sonido percibida.}
%     \label{fig:cross_Y2}
% \end{figure}
...
%     \begin{tabular}{|c|c|c|c|}
%         \hline
%         \textbf{Calidad percibida / Estado de ANC} & \textbf{Alta} & \textbf{Baja} & \textbf{Total} \\
%         \hline
%         Apagado & 24 (41.38\%) & 5 (8.62\%) & 29 (50.0\%) \\
%         \hline
%         Encendido & 12 (20.69\%) & 17 (29.31\%) & 29 (50.0\%) \\
%         \hline
%         Total & 36 (62.07\%) & 22 (37.93\%) & 58 (100.0\%) \\
%         \hline
% \end{tabular}
% \caption{Tabla de contingencia para la calidad de sonido percibida.}
% \label{tab:cross_Y2}
% \end{table}
